                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <blockquote className="min-h-32 flex flex-col gap-4 items-center justify-center border border-gray-300 rounded-md shadow-md">
                            ...
                            <Link href="tel:07087773677" className="text-2xl">07087773677</Link>
                        </blockquote>
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                            <blockquote className="min-h-32 flex flex-col gap-4 items-center justify-center border border-gray-300 rounded-md shadow-md">
                                <FaInstagram className={`text-[] text-5xl`} />
                                <Link href="https://instagram.com/early_code_tech" className=""> @early_code_tech</Link>
                            </blockquote>
                            <blockquote className="min-h-32 flex flex-col gap-4 items-center justify-center border border-gray-300 rounded-md shadow-md">
                                <FaFacebook className={`${themeColors.strongPink} text-5xl`} />
                                <Link href="https://facebook.com/earlycodetech" className="">@earlycodetech</Link>
                            </blockquote>
                            <blockquote className="min-h-32 flex flex-col gap-4 items-center justify-center border border-gray-300 rounded-md shadow-md">
                                <FaXTwitter className={`${themeColors.strongPink} text-5xl`} />
                                <Link href="https://instagram.com/early_code_tech" className="">@earlycodetech</Link>
                            </blockquote>
                        </div>
